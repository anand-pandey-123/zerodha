      ...
      <div className="container border-top mt-5">
        <div className="row mt-5">
          <div className="col">
            ...
            <p className="text-muted">
              &copy; 2010-2024,Zerodha Broking Ltd.<br></br> All rights reserved.
            </p>
            <div className="row border-bottom pb-4">
               
               <div className="col fs-3 text-muted"><i class="fa fa-facebook-official" aria-hidden="true" ></i></div>

               <div className="col fs-3 text-muted"><i class="fa fa-instagram" aria-hidden="true"></i></div>

               <div className="col fs-3 text-muted"><i class="fa fa-linkedin" aria-hidden="true"></i></div>
            ...
            <div className="row pt-2">
               <div className="col fs-3 text-muted"><i class="fa fa-youtube-play" aria-hidden="true"></i></div>

               <div className="col fs-3 text-muted"><i class="fa fa-whatsapp" aria-hidden="true"></i></div>

               <div className="col fs-3 text-muted"><i class="fa fa-telegram" aria-hidden="true"></i></div>
          ...
          <div className="col">
            ...
            <br></br>
            <a href="#"  className="text-muted mt-3"  style={{ textDecoration: "none" }}>
              About
            </a>
            <br></br>
            <a href="#"  className="text-muted "  style={{ textDecoration: "none" }}>
          ...
          <div className="col">
            <p>Support</p>
            <a href="#" className="text-muted " style={{ textDecoration: "none" }}> Contact</a> <br></br>
          ...
          <div className="col">
            ...
            <br></br>
            <a href="#" className="text-muted " style={{ textDecoration: "none" }}>day challenge</a>
            <br></br>
          </div>
        </div>
        ...
        <div className="mt-5 text-muted" style={{fontSize:"13px"}}>
          ...
          <p>
            ...
            account statement issued by NSDL/CDSL every month. "Prevent
            unauthorised transactions in your account. Update your mobile
            numbers/email IDs with your stock brokers. Receive information of
            your transactions directly from Exchange on your mobile/email at the
            end of the day. Issued in the interest of investors. KYC is one time
